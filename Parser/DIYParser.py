...
class DIYParser(AbsParser):

    __topic_article = "diy" # Theme articles
    __url_diy = "https://habr.com/ru/hub/diy/"  # Link for parsing
    __diy = 3
    ...
    async def get_page_link_articles(self):
        async with aiohttp.ClientSession() as session:         
            ...
            for page in range(1,51):
                ...
                url_pages = f"{self.__url_diy}page{page}/"
    ...
    def __write_date_toCSV(self):        
        for data in range(len(self.links)):
            ...
            res = [self.__diy, self.titles[data], self.texts[data]]
