...
class ProgrammingParser(AbsParser):

    __topic_article = "programming" # Theme articles
    __url_programming = "https://habr.com/ru/hub/programming/"  # Link for parsing
    __programming = 5
    ...
    async def get_page_link_articles(self):
        async with aiohttp.ClientSession() as session:         
            ...
            for page in range(1,51):
                ...
                url_pages = f"{self.__url_programming}page{page}/"
    ...
    def __write_date_toCSV(self):        
        for data in range(len(self.links)):
            ...
            res = [self.__programming, self.titles[data], self.texts[data]]
